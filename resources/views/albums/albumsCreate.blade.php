...
@section('content')
    ...
    <form action="/l2admin/albums/create" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="col-4 mx-auto form-container" style="text-align: right;background-color: gainsboro;padding: 20px;font-family:Tajawal-Regular;">
            ...
            <div class="form-group">
            <label>ضع رابط الفيديو (اختياري)</label>
            <input type="text" name="video" class="form-control" id="video" style="text-align: right;">
            </div>
