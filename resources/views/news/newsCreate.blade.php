...
@section('content')
    ...
    <form action="/l2admin/news/create" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="col-4 mx-auto form-container" style="text-align: right;background-color: gainsboro;padding: 20px;font-family:Tajawal-Regular;">
            ...
            <textarea name="body" class="form-control" id="body" placeholder="ادخل الخبر" style="text-align: right;"></textarea>
            </div>
            <div class="form-group">
